...
import { Plus, X, ImagePlus, Trash } from 'lucide-react';
...
const CreateProductPage = ({ onBack }) => {
  ...
  }, [productLoading, productError, dispatch, navigate]);
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
        <h1 className="text-2xl font-semibold mb-6 text-gray-800">Create New Product</h1>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
          ...
          <div className="mt-6 flex justify-end">
            <button
              onClick={onBack}
              className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-3 px-6 rounded focus:outline-none focus:shadow-outline mr-4"
            >
              Cancel
            </button>
            <button
            ...
            >
              {productLoading === 'pending' || cloudinaryLoading ? 'Creating...' : 'Create Product'}
            </button>
          </div>
        </form>
      </div>
